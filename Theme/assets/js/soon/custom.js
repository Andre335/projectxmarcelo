...
(function($) {
    ...
    **/
    var launch = new Date(2015, 01, 1, 12, 00, 00);
    /**
    * The script
    **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        if( launch < now ){
            ...
            message.html('<p>Quando? Sabado!</p><br> <p>Que Horas? Meio Dia!</p><br> <p>O que levar? Birita e sua presença</p><br>');
        }
        else{
            ...
            message.html('Altas aventuras sendo preparadas...');
        }
    }
})(jQuery);
/******************************************************************************************************************************
